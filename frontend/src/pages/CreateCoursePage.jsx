...
import { Plus, Trash2, ImagePlus, HelpCircle } from "lucide-react"
...
const CreateCoursePage = () => {
  ...
  // Logs form data to console and shows success message
  const handleSubmit = (e) => {
    e.preventDefault()
    const courseData = { title, description, category, price: Number(price), status, sections }
    console.log("Course data:", courseData)
    setSuccess("Course created successfully (dummy)")
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full bg-[#2563EB] text-white py-2.5 rounded-lg font-medium text-sm hover:bg-[#1E3A8A] transition-colors cursor-pointer"
          >
            Create Course
          </button>
        </form>
